...
if(isset($_POST['tour-submitted'])) {

    $email = trim($_POST['tour-email']);
    $name = trim($_POST['tour-name']);
    $phone = trim($_POST['tour-number']);
    $message = trim($_POST['tour-message']);
