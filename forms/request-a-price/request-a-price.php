...
if(isset($_POST['price-submitted'])) {

    $email = trim($_POST['price-email']);
    $name = trim($_POST['price-name']);
    $phone = trim($_POST['price-number']);
    $message = trim($_POST['price-message']);
