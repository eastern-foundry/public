...
{featureType:"road",elementType:"labels.icon",stylers:[{visibility:"off"}]},{},{featureType:"poi",elementType:"geometry.fill",stylers:[{color:"#dadada"}]}]},b=document.getElementById("map"),a=new google.maps.Map(b,a);new google.maps.Marker({position:new google.maps.LatLng(38.902524,-77.0412842),map:a,title:"Nileforest",icon:"/img/map-marker.png"})};
